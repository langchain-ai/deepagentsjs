...
export function getToolUsageRelationalDatasetName(runner: EvalRunner) {
  return "deepagents-js-tool-usage-relational";
}

export function getToolUsageRelationalDescribeOptions(runner: EvalRunner) {
  return { projectName: runner.name, upsert: true };
}
