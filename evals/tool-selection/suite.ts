...
export function getToolSelectionDatasetName(runner: EvalRunner) {
  return "deepagents-js-tool-selection";
}

export function getToolSelectionDescribeOptions(runner: EvalRunner) {
