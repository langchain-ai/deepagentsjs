...
export function getMemoryAgentBenchDatasetName(runner: EvalRunner) {
  return "deepagents-js-memory-agent-bench";
}

export function getMemoryAgentBenchDescribeOptions(runner: EvalRunner) {
