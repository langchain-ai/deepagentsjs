...
describe("ChatBaseten", () => {
  ...
  // -------------------------------------------------------------------------
  // _generate override: response metadata enrichment
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // _streamResponseChunks override
  // -------------------------------------------------------------------------
  ...
  describe("_streamResponseChunks", () => {
    ...
    it("strips usage_metadata from content chunks", async () => {
      ...
      const superStream = vi
        ...
        .mockReturnValueOnce(
          fakeStream([contentChunk, usageOnlyChunk]),
        );
...
// ---------------------------------------------------------------------------
// normalizeToolCallChunks (unit, exported)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// normalizeModelUrl (unit, exported)
// ---------------------------------------------------------------------------
