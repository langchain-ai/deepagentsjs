...
/**
 * Zod schema for validating a single task row in tasks.jsonl.
 */
...
/**
 * Serialize an array of task specs to JSONL format.
 *
 * One JSON object per line, terminated with a trailing newline.
 */
export function serializeTasksJsonl(tasks: SwarmTaskSpec[]): string {
